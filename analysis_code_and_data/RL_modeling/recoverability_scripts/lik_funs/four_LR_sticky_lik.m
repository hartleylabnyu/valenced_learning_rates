...
function [lik, latents] = four_LR_sticky_lik(block_order, block, choices, rewards, x, priors)

beta = x(1);
choice_c = x(2);
alpha_pos_risk_good = x(3);
alpha_neg_risk_good = x(4);
alpha_pos_risk_bad = x(5);
alpha_neg_risk_bad = x(6);
