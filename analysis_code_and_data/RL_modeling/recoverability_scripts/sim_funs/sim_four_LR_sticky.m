...
function [choices, rewards, blocks, latents] = sim_four_LR_sticky(task_struct, params)
...
beta = params(1);
choice_c = params(2);
alpha_pos_risk_good = params(3);
alpha_neg_risk_good = params(4);
alpha_pos_risk_bad = params(5);
alpha_neg_risk_bad = params(6);
