...
function [lik, latents] = decay_two_alpha_two_eta_lik(block_order, block, choices, rewards, x, priors)
...
if (priors)
    ...
    lik= lik+log(pdf('beta', eta_pos, 1.1,1.1));
    lik= lik+log(pdf('beta', eta_neg, 1.1,1.1));
