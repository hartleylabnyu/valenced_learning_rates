...
function [choices, rewards, blocks, latents] = sim_decay_four_alpha_four_eta(task_struct, params)
...
eta_pos_risk_good = params(7);
eta_neg_risk_good = params(8);
eta_pos_risk_bad = params(9);
eta_neg_risk_bad = params(10);
