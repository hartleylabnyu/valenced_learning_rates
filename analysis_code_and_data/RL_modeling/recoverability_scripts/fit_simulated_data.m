...
filename = '../output/fits_4LR_sticky';

% Determine models to fit
models = {'four_LR_sticky'};
%models = {'one_LR_sticky', 'two_LR_sticky', 'four_LR_sticky', ...
...
for d = 1:num_sim_datasets %loop through simulated datasets
    ...
    for m = 1:num_models_to_fit % loop through models to be fit
        ...
        elseif strcmp(model_to_fit, 'four_LR')
            ...
            %w/ stickiness param
        elseif strcmp(model_to_fit, 'one_LR_sticky')
            n_params = 3;
            lb = [1e-6, -10, 1e-6]; %determine the lower bounds of the parameters
            ub = [30, 10, 1]; %determine the upper bounds of the parameters
        elseif strcmp(model_to_fit, 'two_LR_sticky')
            n_params = 4;
            lb = [1e-6, -10, 1e-6, 1e-6];
            ub = [30, 10, 1, 1];
        elseif strcmp(model_to_fit, 'four_LR_sticky')
            n_params = 6;
            lb = [1e-6, -10, 1e-6, 1e-6, 1e-6, 1e-6];
            ub = [30, 10, 1, 1, 1, 1];
            
            %decay models
        elseif strcmp(model_to_fit, 'decay_one_alpha_one_eta')
            n_params = 4;
            lb = [1e-6, -10, 1e-6, 1e-6]; %determine the lower bounds of the parameters
            ub = [30, 10, 1, 1]; %determine the upper bounds of the parameters
        elseif strcmp(model_to_fit, 'decay_two_alpha_one_eta')
            n_params = 5;
            lb = [1e-6, -10, 1e-6, 1e-6, 1e-6];
            ub = [30, 10, 1, 1, 1];
        elseif strcmp(model_to_fit, 'decay_four_alpha_one_eta')
            n_params = 7;
            lb = [1e-6, -10, 1e-6, 1e-6, 1e-6, 1e-6, 1e-6];
            ub = [30, 10, 1, 1, 1, 1, 1];
            
        elseif strcmp(model_to_fit, 'decay_one_alpha_two_eta')
            n_params = 5;
            lb = [1e-6, -10, 1e-6, 1e-6, 1e-6]; %determine the lower bounds of the parameters
            ub = [30, 10, 1, 1, 1]; %determine the upper bounds of the parameters
        elseif strcmp(model_to_fit, 'decay_two_alpha_two_eta')
            n_params = 6;
            lb = [1e-6, -10, 1e-6, 1e-6, 1e-6, 1e-6];
            ub = [30, 10, 1, 1, 1, 1];
        elseif strcmp(model_to_fit, 'decay_four_alpha_two_eta')
            n_params = 8;
            lb = [1e-6, -10, 1e-6, 1e-6, 1e-6, 1e-6, 1e-6, 1e-6];
            ub = [30, 10, 1, 1, 1, 1, 1, 1];
            
        elseif strcmp(model_to_fit, 'decay_one_alpha_four_eta')
            n_params = 7;
            lb = [1e-6, -10, 1e-6, 1e-6, 1e-6,1e-6, 1e-6]; %determine the lower bounds of the parameters
            ub = [30, 10, 1, 1, 1, 1, 1]; %determine the upper bounds of the parameters
        elseif strcmp(model_to_fit, 'decay_two_alpha_four_eta')
            n_params = 8;
            lb = [1e-6, -10, 1e-6, 1e-6, 1e-6, 1e-6, 1e-6, 1e-6];
            ub = [30, 10, 1, 1, 1, 1, 1, 1];
        elseif strcmp(model_to_fit, 'decay_four_alpha_four_eta')
            n_params = 10;
        ...
        % determine function
        function_name = [model_to_fit, '_lik'];
