...
Tasks, data, and analysis code for: Nussenbaum, K., Velez, J.A., Washington, B.T., Hamling, H.E., & Hartley, C.A. (2022). Flexibility in valenced reinforcement learning computations across development. [*Child Development.*](https://srcd.onlinelibrary.wiley.com/doi/full/10.1111/cdev.13791)
