...
function [choices, rewards, blocks, latents] = sim_decay_one_alpha_four_eta(task_struct, params)
...
choice_c = params(2);
alpha_init = params(3);
eta_pos_risk_good = params(4);
eta_neg_risk_good = params(5);
eta_pos_risk_bad = params(6);
eta_neg_risk_bad = params(7);
